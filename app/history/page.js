    ...
    <div className="container">
      <div className="page">
        ...
        <div className="section-header">
          ...
          <p className="page-section-description">
            The multifaceted projects of Interspecies Communication were funded by the generous donations from readers of the newsletter in addition to support from various donors, grants, and media appearances. Projects include the  <span className="footnote" onClick={()=>footnoteClick("Human/Dolphin Foundation")}>Human/Dolphin Foundation</span>, a collaboration with <span className="footnote" onClick={()=>footnoteClick("John C. Lilly")}>John</span> and Toni Lilly in Careyes, Mexico; the <span className="footnote" onClick={()=>footnoteClick("The Orca Project")}>Orca Project</span> an annual expedition to the Johnstone Strait in Canada to record musical interactions with wild orcas; development of <span className="footnote" onClick={()=>footnoteClick("Custom electronics")}>custom electronics and recording equipment</span> for in-situ recordings of animals and environment with engineers Richard Ferarro, Mike Sofen, and Mark Fischer; collaborative efforts with the indigenous Aborigines of <span className="footnote" onClick={()=>footnoteClick("Lake Tyers, Australia")}>Lake Tyers, Australia</span> to rescue a stranded dolphin community; using music and sound to help <span className="footnote" onClick={()=>footnoteClick("Operation Breakthrough")}>free gray whales</span> caught in the Barrow Strait, Alaska; developing <span className="footnote" onClick={()=>footnoteClick("The Beluga Cafe")}>longterm communication programs</span> with beluga whale populations in the Arctic Circle; collaborating with writer and artist <span className="footnote" onClick={()=>footnoteClick("Micky Remann")}>Micky Remann</span> on the development and implementation of underwater musical performances; as well as <span className="footnote" onClick={()=>footnoteClick("Interspecies presentations")}>giving talks, leading seminars, and exhibiting work</span> on interspecies communication internationally.
          </p>
          <p className="page-section-description">
