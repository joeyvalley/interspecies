    ...
    <div className="container">
      <div className="page">
        ...
        <section className='section-block-last'>
          ...
          <p className="section-description">If these ideas at first seem a bit overblown and even precious, remember that Interdependence is the very cornerstone of natural law. If this law can somehow be transmuted into a human societal ethic, it becomes an important tool for forever alter- ing the destructive course of modern exploit- ing human society. Likewise, any activity which promotes the interdependent worldview demands serious consideration and promotion. 
          </p>
